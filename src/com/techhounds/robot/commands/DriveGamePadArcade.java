 ...
 * @author cRIO-devel
 */
public class DriveGamePadArcade extends Command {

    private final DriveSubsystem drive;
    private final OI oi;
    
    public DriveGamePadArcade(DriveSubsystem drive) {
    ...
    protected void execute() {
        double leftPower = oi.getArcadeLeftPower();
        double rightPower = oi.getArcadeRightPower();
